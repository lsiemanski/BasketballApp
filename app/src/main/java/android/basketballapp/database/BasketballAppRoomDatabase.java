    ...
    private static RoomDatabase.Callback roomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriterExecutor.execute(() -> {
                ...
                Drill drill = new Drill(DrillNames.FIVE_POSITION_3_POINT_SHOOTING, "5_position_drill.html", 10, shooting.id);
                drillDao.insert(drill);
                Drill drill1 = new Drill(DrillNames.FREE_THROW_SHOOTING, "free_throw_shooting_drill.html", 20, shooting.id);
                drillDao.insert(drill1);
                Drill drill2 = new Drill(DrillNames.RAY_ALLEN_DRILL, "ray_allen_drill.html", 0, shooting.id);
                drillDao.insert(drill2);
                Drill drill3 = new Drill(DrillNames.FORM_SHOOTING, "form_shooting.html", 0, shooting.id);
                drillDao.insert(drill3);
                Drill drill4 = new Drill(DrillNames.WARMUP_DRIBBLING, "warmup_dribbling.html", 0, dribbling.id);
